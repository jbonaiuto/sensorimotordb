...
from sensorimotordb.models import ExperimentExportRequest, Experiment, VisuomotorClassificationAnalysisResults, Analysis, Species, Condition, GraspCondition, GraspObservationCondition
...
class ExperimentForm(ModelForm):
    ...
    data_file=forms.FileField(widget=forms.FileInput, required=True)
...
class ConditionInlineForm(ModelForm):
    ...
    trial_type=forms.CharField(max_length=10,widget=forms.HiddenInput,required=True)
    object=forms.CharField(max_length=10,widget=forms.HiddenInput,required=True)
